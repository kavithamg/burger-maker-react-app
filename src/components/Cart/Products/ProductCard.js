...
const ProductCard = (props) => {
    return (
        <div>
            ...
            <button onClick={() => props.quantityAction('add', props.productId)}>Add quantity</button>
            <button onClick={() => props.quantityAction('remove', props.productId)}>Remove quantity</button>
            <button onClick={() => props.deleteAction(props.productId)}>Remove Product</button>
        </div>
    )
}
